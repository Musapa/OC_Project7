...
public class BidControllerTests {
	...
	private void testAddBid() throws Exception {
	...
	private void testAddValidateInvalid() throws Exception {
		mockMvc.perform(post("/bidList/validate").param("accountInvalid", "test@mail.com").param("type", "1234")
				.param("bidQuantity", "20")).andExpect(view().name("bidList/add")).andExpect(model().errorCount(1))
	...
	private void testUpdateBid() throws Exception {
	...
	private void testDeleteBid() throws Exception {
